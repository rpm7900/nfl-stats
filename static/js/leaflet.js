...
var cardinalsIcon = new teamIcon({iconUrl: 'https://static.nfl.com/static/site/img/logos/svg/teams/ARI.svg'}),
    ...
    ramsIcon = new teamIcon({iconUrl: 'https://static.nfl.com/static/site/img/logos/svg/teams/LA.svg', iconAnchor: [5, 5]})
    ...
    redskinsIcon = new teamIcon({iconUrl: 'https://static.nfl.com/static/site/img/logos/svg/teams/WAS.svg', iconAnchor: [5, 5]})
    ...
    jetsIcon = new teamIcon({iconUrl: 'https://seeklogo.net/wp-content/uploads/2011/05/new-york-jets-logo-vector-01.png', iconAnchor: [5, 5]})
